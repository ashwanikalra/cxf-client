 ...
 * 2022-08-14T15:36:59.002+05:30
 * Generated source version: 3.5.3
 *
 */
@WebServiceClient(name = "CustomerService",
                  wsdlLocation = "file:/C:/ash/code/cxf-client/src/main/resources/wsdl/reservation.wsdl",
...
public class CustomerService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/ash/code/cxf-client/src/main/resources/wsdl/reservation.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/ash/code/cxf-client/src/main/resources/wsdl/reservation.wsdl");
        }
        WSDL_LOCATION = url;
    }
